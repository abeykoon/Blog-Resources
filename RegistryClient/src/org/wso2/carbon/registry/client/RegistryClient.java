...
* under the License.
*/
package org.wso2.carbon.registry.client;
...
public class RegistryClient {
    ...
    private static final String PATH_TO_KEYSTORE = "src/main/resources/security/wso2carbon.jks";

    // configuration locations used to bootstrap axis2
    private static final String axis2Repo = "src/main/resources/client";
    private static final String axis2Conf = "src/main/resources/conf/axis2_client.xml";
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            String resourcePath = "/_system/config/repository/components/org.wso2.carbon.ndatasource";
            ...
            Resource getResource = registry.get("/_system/config/repository/components/org.wso2.carbon.ndatasource");
            ...
            System.out.println("Error while dealing with resources in registry");
            e.printStackTrace();
        }
        finally {
            //Close the session
